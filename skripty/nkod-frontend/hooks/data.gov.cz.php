...
define('LOGFILE', '/data/gh-log/gh.log');

// what command to execute upon retrieval of a valid push event
$cmd = 'cd /data/opendata-mvcr.github.io && git fetch --all && git checkout --force "origin/master"';
...
$required_data = array(
        ...
        'repository' => array(
                'full_name' => 'opendata-mvcr/opendata-mvcr.github.io',
        ),
);
